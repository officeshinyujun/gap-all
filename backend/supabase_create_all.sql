...
ALTER TABLE ONLY public.flagged_questions ADD CONSTRAINT flagged_questions_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.question_seen_records ADD CONSTRAINT question_seen_records_pkey PRIMARY KEY (user_id, question_id);

ALTER TABLE ONLY public.textbook_chunks ADD CONSTRAINT textbook_chunks_pkey PRIMARY KEY (id);
